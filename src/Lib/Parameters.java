...
//	public static final int
	...
	public static final int RUNE_SNIPER_CD = 20 * 3; //狙撃手CD
	public static final double RUNE_SNIPER_SPI = 1.5; //狙撃手弾速
	public static final double RUNE_SNIPER_SPI_ENHANCED = 2; //強化狙撃手 弾速強化
