...
//	BATTLE_TOKKOYARO(1, BATTLE_TOKKOYARO_NAME, BATTLE_TOKKOYARO_LORE, SHEARS, ATTACK), //特攻野郎
	...
	BATTLE_SNIPER(1, BATTLE_SNIPER_NAME, BATTLE_SNIPER_LORE, BOW, ATTACK), //スナイパー
	/* === 錬金系Tier1 === */
...
//	MAGIC_PERFUME(1, MAGIC_PERFUME_NAME, MAGIC_PERFUME_LORE, PHANTOM_MEMBRANE, MAGIC),//魔法の香水
	...
	MAGIC_LINKAGE(1, MAGIC_LINKAGE_NAME, MAGIC_LINKAGE_LORE, SPAWNER, MAGIC), //TODO 共鳴 TODO
	/* === 敏捷系 Tier1 === */
...
//	COLLECT_SCAVENGER(1, COLLECT_SCAVENGER_NAME, COLLECT_SCAVENGER_LORE, IRON_SWORD, COLLECT),
	...
	COLLECT_ARROWSIGHT(1, COLLECT_ARROWSIGHT_NAME, COLLECT_ARROWSIGHT_LORE, ENDER_EYE, COLLECT), //TODO
//	COLLECT_CAREPACKAGE(1, COLLECT_CAREPACKAGE_NAME, COLLECT_CALEPACKAGE_LORE, CHEST, COLLECT), //TODO ケアパケ TODO
	/* === 戦闘系 Tier2 === */
	...
	BATTLE_NEBANEBA(2, BATTLE_2_NEBANEBA_NAME, BATTLE_2_NEBANEBA_LORE, COBWEB, ATTACK),
	BATTLE_PICAPICA(2, BATTLE_2_PICAPICA_NAME, BATTLE_2_PICAPICA_LORE, GLOWSTONE, ATTACK),
	/* === 錬金系 Tier2 === */
...
//	MAGIC_LVSTEAL(), TODO 実装する 相手の経験値を吸う
	...
	MAGIC_SAFETY(2, MAGIC_2_SAFETY_NAME, MAGIC_2_SAFETY_LORE, DIAMOND_CHESTPLATE, MAGIC),
	MAGIC_INSURANCE(2, MAGIC_2_INSURANCE_NAME, MAGIC_2_INSURANCE_LORE, PAPER, MAGIC),
	/* === 俊敏系 Tier2 === */
	...
	public static Runes getRune(ItemStack item) {
		...
		for (Runes r :Runes.values()) {
			if (r.getMaterial() == mat) { //マテリアルが同じ
				if (r.toString().equalsIgnoreCase(itemName)) {
					return r;
				}
			}
		}
