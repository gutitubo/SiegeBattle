...
public enum Runes {
	...
	BATTLE_ARROWDAMAGE(2, BATTLE_2_ARROWDAMAGE_NAME, BATTLE_2_ARROWDAMAGE_LORE, IRON_SWORD, ATTACK),
	BATTLE_ANTIDEFENDER(2, BATTLE_2_ANTIDEFENDER_NAME, BATTLE_2_ANTIDEFENDER_LORE, IRON_SWORD, ATTACK),
	BATTLE_HEALTHBOOST(2, BATTLE_2_HEALTHBOOST_NAME, BATTLE_2_HEALTHBOOST_LORE, IRON_SWORD, ATTACK),
	BATTLE_REGENERATION(2, BATTLE_2_REGENERATION_NAME, BATTLE_2_REGENERATION_LORE, IRON_SWORD, ATTACK),
	BATTLE_ANTIATTACKER(2, BATTLE_2_ANTIATTACKER_NAME, BATTLE_2_ANTIATTACKER_LORE, IRON_SWORD, ATTACK),
	BATTLE_COREDIGSPEED(2, BATTLE_2_COREDIGSPEED_NAME, BATTLE_2_COREDIGSPEED_LORE, IRON_SWORD, ATTACK),
	/* === 錬金系 Tier2 === */
	MAGIC_ENCHANT(2, MAGIC_2_ENCHANT_NAME, MAGIC_2_ENCHANT_LORE, IRON_SWORD, MAGIC),
	MAGIC_POTION_AMP(2, MAGIC_2_POTION_AMP_NAME, MAGIC_2_POTION_AMP_LORE, IRON_SWORD, MAGIC),
	MAGIC_POTION_DUR(2, MAGIC_2_POTION_DUR_NAME, MAGIC_2_POTION_DUR_LORE, IRON_SWORD, MAGIC),
	MAGIC_EXPUP(2, MAGIC_2_EXPUP_NAME, MAGIC_2_EXPUP_LORE, IRON_SWORD, MAGIC),
	MAGIC_KEYSTONE(2, MAGIC_2_KEYSTONE_NAME, MAGIC_2_KEYSTONE_LORE, IRON_SWORD, MAGIC),
	MAGIC_KILLPOTION(2, MAGIC_2_KILLPOTION_NAME, MAGIC_2_KILLPOTION_LORE, IRON_SWORD, MAGIC),
	MAGIC_EXPARMOR(2, MAGIC_2_EXPARMOR_NAME, MAGIC_2_EXPARMOR_LORE, IRON_SWORD, MAGIC),
	/* === 俊敏系 Tier2 === */
	SWIFT_SPEEDUP(2, SWIFT_2_SPEEDUP_NAME, SWIFT_2_SPEEDUP_LORE, IRON_SWORD, SWIFT),
	SWIFT_JUMPBOOST(2, SWIFT_2_JUMPBOOST_NAME, SWIFT_2_JUMPBOOST_LORE, IRON_SWORD, SWIFT),
	SWIFT_NOFALL(2, SWIFT_2_NOFALL_NAME, SWIFT_2_NOFALL_LORE, IRON_SWORD, SWIFT),
	SWIFT_NOHUNGRY(2, SWIFT_2_NOHUNGRY_NAME, SWIFT_2_NOHUNGRY_LORE, IRON_SWORD, SWIFT),
	SWIFT_HOMEGUARD(2, SWIFT_2_HOMEGUARD_NAME, SWIFT_2_HOMEGUARD_LORE, IRON_SWORD, SWIFT),
	SWIFT_RUNNER(2, SWIFT_2_RUNNER_NAME, SWIFT_2_RUNNER_LORE, IRON_SWORD, SWIFT),
	/* === 収集系 Tier2 === */
	COLLECT_IRON(2, COLLECT_2_IRON_NAME, COLLECT_2_IRON_LORE, IRON_SWORD, COLLECT),
	COLLECT_GOLD(2, COLLECT_2_GOLD_NAME, COLLECT_2_GOLD_LORE, IRON_SWORD, COLLECT),
	COLLECT_DIA(2, COLLECT_2_DIA_NAME, COLLECT_2_DIA_LORE, IRON_SWORD, COLLECT),
	COLLECT_RED(2, COLLECT_2_RED_NAME, COLLECT_2_RED_LORE, IRON_SWORD, COLLECT),
	COLLECT_LUCK(2, COLLECT_2_LUCK_NAME, COLLECT_2_LUCK_LORE, IRON_SWORD, COLLECT),
	COLLECT_RECALL(2, COLLECT_2_RECALL_NAME, COLLECT_2_RECALL_LORE, IRON_SWORD, COLLECT),
	COLLECT_HUMANFORGE(2, COLLECT_2_HUMANFORGE_NAME, COLLECT_2_HUMANFORGE_LORE, IRON_SWORD, COLLECT),
	;
